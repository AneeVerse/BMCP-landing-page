...
function Sec({ children, bg = "#fff", id }: { children: React.ReactNode; bg?: string; id?: string }) {
  const f = useFadeIn();
  return (
    <section ref={f.ref as React.RefObject<HTMLElement>} style={{ ...f.style, background: bg, padding: "72px 0" }} id={id}>
